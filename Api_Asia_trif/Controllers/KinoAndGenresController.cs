...
namespace Api_Asia_trif.Controllers
{
    public class KinoAndGenresController : ApiController
    {
        ...
        [ResponseType(typeof(List<KinoAndGenreModel>))]
        public IHttpActionResult GetKinoAndGenre()
        {
            return Ok(db.KinoAndGenre.ToList().ConvertAll(x => new KinoAndGenreModel(x)));
        }
